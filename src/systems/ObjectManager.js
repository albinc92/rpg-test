...
class ObjectManager {
    ...
    createStaticObject(mapId, def) {
        const obj = new StaticObject({
            ...
            collisionPercent: def.collisionPercent || 0.15,
            collisionWidthPercent: def.collisionWidthPercent,
            collisionHeightPercent: def.collisionHeightPercent,
            collisionOffsetX: def.collisionOffsetX || 0,
            collisionOffsetY: def.collisionOffsetY || 15,
