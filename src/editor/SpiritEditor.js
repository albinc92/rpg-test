...
class SpiritEditor {
    ...
    createPanel() {
        ...
        header.innerHTML = EditorStyles.createHeader(theme, '✨ Spirit Template Editor', 'Create, Edit, and Delete Spirit Templates', this.game);
    ...
    showForm(template = null) {
        ...
        movementTitle.style.cssText = EditorStyles.getSectionTitleStyle(this.game);
        form.appendChild(movementTitle);

        // Movement Pattern dropdown
        const patternContainer = document.createElement('div');
        patternContainer.style.cssText = EditorStyles.getFieldContainerStyle(this.game);
        const patternLabel = document.createElement('label');
        patternLabel.textContent = 'Movement Pattern';
        patternLabel.style.cssText = EditorStyles.getLabelStyle(this.game);
        patternContainer.appendChild(patternLabel);
        const patternSelect = document.createElement('select');
        patternSelect.name = 'movementPattern';
        patternSelect.style.cssText = EditorStyles.getInputStyle(this.game);
        ...
        statsTitle.style.cssText = EditorStyles.getSectionTitleStyle(this.game);
        ...
        behaviorTitle.style.cssText = EditorStyles.getSectionTitleStyle(this.game);
